...
out_dir <- '/common/lir2lab/Olivia/Model-Evaluation/consortium/result/prscs/'
phenos <- c("t2d", "breast_cancer", "ad", "hdl", "ldl", "bmi", "cholesterol")
binaries <- c(TRUE, TRUE, TRUE, FALSE, FALSE, FALSE, FALSE) 
