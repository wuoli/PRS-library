...
#SBATCH --output=/common/lir2lab/Olivia/Model-Evaluation/consortium/result/log/plinkpt/score2/32_plinkpt_score2_%A_%a.out # Standard output log
#SBATCH --error=/common/lir2lab/Olivia/Model-Evaluation/consortium/result/log/plinkpt/score2/32_plinkpt_score2_%A_%a.err  # Standard error log
#SBATCH --array=6
...
Rscript /common/lir2lab/Olivia/Model-Evaluation/consortium/code/42_plinkpt_score2.R $pheno $pheno_file $score_dir
