...
#SBATCH --output=/common/lir2lab/Olivia/Model-Evaluation/consortium/result/log/megaprs/score/32_megaprs_score2_%A_%a.out # Standard output log
#SBATCH --error=/common/lir2lab/Olivia/Model-Evaluation/consortium/result/log/megaprs/score/32_megaprs_score2_%A_%a.err  # Standard error log
#SBATCH --array=7
...
Rscript /common/lir2lab/Olivia/Model-Evaluation/consortium/code/32_megaprs_score2.R $pheno $pheno_file $score_dir
